      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
                      ...
                      {property.photos.map((_, index) => (
                        <button
                          ...
                          className={`w-2.5 h-2.5 rounded-full ${
                            currentPhotoIndex === index ? "bg-indigo-600" : "bg-white/60"
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  {property.photos.map((photo, index) => (
                    <div 
                      ...
                      className={`cursor-pointer flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-all ${
                        currentPhotoIndex === index ? "border-indigo-600 shadow-md" : "border-transparent"
                      }`}
                    >
                      <img
                        src={photo.url}
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-1 text-yellow-500">
                    ...
                    <span className="ml-2 text-gray-700 font-medium">4.8 (42 reviews)</span>
                  </div>
            ...
            {/* Location Details - Added renderLocationDetails output here */}
            <div className="mt-6">
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden sticky top-6">
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-center gap-1 mb-2">
                  <span className="text-2xl font-bold text-gray-900">{property.currency} {property.pricePerNight}</span>
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-700 flex-shrink-0">✓</span>
                    <span className="text-gray-600">{property.bedrooms} bedrooms and {property.bathrooms} bathrooms</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-700 flex-shrink-0">✓</span>
                    <span className="text-gray-600">Premium {property.type} property</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-700 flex-shrink-0">✓</span>
                    <span className="text-gray-600">Great location in {property.location?.city || "the area"}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-700 flex-shrink-0">✓</span>
                    <span className="text-gray-600">Top-rated property (4.8/5)</span>
                  </li>
                </ul>
              </div>
            </div>

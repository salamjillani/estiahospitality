          ...
          <div className="relative z-10 text-center">
            ...
            <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100">
                <span className="block text-3xl font-bold text-blue-600 mb-1">250+</span>
                <span className="text-gray-600 text-sm">Luxury Properties</span>
              </div>
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100">
                <span className="block text-3xl font-bold text-blue-600 mb-1">42</span>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100">
                <span className="block text-3xl font-bold text-blue-600 mb-1">4.9</span>
        ...
        <section id="curated-collection" className="mb-28">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div>
              ...
              <p className="text-gray-600 mt-3 max-w-2xl">
                Handpicked properties that define luxury living in the world&apos;s most beautiful locations
              </p>
            </div>
          </div>
        ...
        <div className="mb-28 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div>
              ...
              <p className="text-gray-600 mt-3 max-w-2xl">
                Our properties feature these exclusive amenities for the ultimate luxury experience
              </p>
            </div>
          </div>
